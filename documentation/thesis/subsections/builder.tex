...
Egy példa a Java standard könyvtárából a \code{StringBuilder}. Segítségével képesek vagyunk egy stringet felépíteni kisebb szerkezeti egységek hozzáadásával, majd az így kapott karaktersorozatot megkapni. Az \code{insert} és \code{append} metódusai számos overload-dal rendelkeznek, így rugalmasabban tudjuk felépíteni a kívánt végeredményt. \par
